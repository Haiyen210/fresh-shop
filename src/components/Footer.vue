            ...
            <div class="row">
              <div class="col-xl-3 col-md-6 col-12">
                <div class="ltn__feature-item ltn__feature-item-8">
                  ...
                  <div class="ltn__feature-info">
                    ...
                    <p>Cung cấp Sản phẩm được tuyển chọn cho tất cả các sản phẩm trên $ 100</p>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 col-12">
              ...
              <div class="col-xl-3 col-md-6 col-12">
                <div class="ltn__feature-item ltn__feature-item-8">
                  ...
                  <div class="ltn__feature-info">
                    <h4>Đồ ăn từ thiên nhiên</h4>
                    <p>Đổi trả sản phẩm trong vòng 3 ngày đối với bất kỳ sản phẩm nào bạn mua</p>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 col-12">
                <div class="ltn__feature-item ltn__feature-item-8">
                  ...
                  <div class="ltn__feature-info">
                    ...
                    <p>Chúng tôi đảm bảo chất lượng sản phẩm mà bạn có thể tin tưởng dễ dàng
                    </p>
                  </div>
                </div>
              </div>
                ...
                <ul>
                  <li>
                    ...
                    <div class="footer-address-info">
                      <p>238 Hoàng Quốc Việt, Cổ Nhuế 1, Cầu Giấy, Hà Nội</p>
                    </div>
                  </li>
                  <li>
                    <div class="footer-address-icon">
                    ...
                    <div class="modal-product-info">
                      ...
                      <div class="ltn__product-details-menu-2">
                        <ul>
                          ...
                          <li>
                            <a href="#" class="theme-btn-1 btn btn-effect-1" title="Add to Cart" data-toggle="modal"
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="modal-product-info">
                      ...
                      <div class="btn-wrapper">
                        <router-link :to="{ name: 'Cart' }" class="theme-btn-1 btn btn-effect-1">View Cart</router-link>
