<template>
      ...
      <div class="ltn__utilize-menu">
        <ul>
          <li>
            <a href="#">Home</a>
            <ul class="sub-menu">
              <li><a href="index-2.html">Home Pages 01</a></li>
              <li><a href="index-3.html">Home Pages 02</a></li>
              <li><a href="index-4.html">Home Pages 03</a></li>
              <li><a href="index-5.html">Home Pages 04</a></li>
              <li>
                <a href="index-6.html"
                  >Home Pages 05 <span class="menu-item-badge">video</span></a
                >
              </li>
              <li><a href="index-7.html">Home Pages 06</a></li>
              <li><a href="index-8.html">Home Pages 07</a></li>
              <li><a href="index-9.html">Home Pages 08</a></li>
              <li><a href="index-10.html">Home Pages 09</a></li>
              <li><a href="index-11.html">Home Pages 10</a></li>
              <li>
                <a href="index-12.html"
                  >Home Pages 11 <span class="menu-item-badge">Service</span></a
                >
              </li>
            </ul>
          </li>
                ...
                <div class="slide-item-info">
                  <div class="slide-item-info-inner ltn__slide-animation">
                    ...
                    <div class="btn-wrapper animated">
                      ...
                      <a
                        href="about.html"
                        class="btn btn-transparent btn-effect-3 text-uppercase"
                        >LEARN MORE</a
                      >
                    </div>
                  </div>
          ...
          <div class="tab-content">
            <div class="tab-pane fade active show" id="liton_tab_3_1">
              <div class="ltn__product-tab-content-inner">
                <div
                  class="row ltn__tab-product-slider-one-active slick-arrow-1"
                >
                  <!-- ltn__product-item -->
                  <div class="col-lg-12">
                    <div
  ...
  <div
    class="ltn__call-to-action-area ltn__call-to-action-4 section-bg-1 pt-110 pb-120"
  >
    <div class="container">
      <div class="row">
        <div class="col-lg-5">
        ...
        <div class="col-lg-7">
          <div
            class="call-to-action-inner call-to-action-inner-4 text-color-white--- text-center---"
          >
            <div class="section-title-area ltn__section-title-2 text-center---">
            ...
            <div
              class="ltn__countdown ltn__countdown-3 bg-white--"
  ...
  <div class="ltn__testimonial-area section-bg-1 pt-290 pb-70">
    <div class="container-fluid">
      ...
      <div
        class="row ltn__testimonial-slider-3-active slick-arrow-1 slick-arrow-1-inner"
      >
        <div class="col-lg-12">
        ...
        <div class="col-lg-12">
          <div class="ltn__blog-item ltn__blog-item-3">
            ...
            <div class="ltn__blog-brief">
              ...
              <h3 class="ltn__blog-title">
                <a href="blog-details.html"
                  >How and when to replace brake rotors</a
                >
              </h3>
              <div class="ltn__blog-meta-btn">
                <div class="ltn__blog-meta">
        ...
        <div class="col-lg-12">
          <div class="ltn__blog-item ltn__blog-item-3">
            ...
            <div class="ltn__blog-brief">
              ...
              <h3 class="ltn__blog-title">
                <a href="blog-details.html">Healthiest Vegetables on Earth</a>
              </h3>
              <div class="ltn__blog-meta-btn">
                <div class="ltn__blog-meta">
                  <ul>
